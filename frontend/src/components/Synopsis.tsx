    ...
    <div className="container mx-auto px-6 max-w-4xl text-center">
      ...
      <div className="space-y-6 text-lg text-gray-700">
        ...
        <p>
          ...
          caminando con esperanza. El milagro que esperas puede estar más cerca
          de lo que imaginas.
        </p>
        <p>
          ...
          Mantente fiel a tus principios, sigue intentándolo y recuerda que cada
          paso cuenta.
        </p>
        <p>
          En este libro, <span className="font-bold">"Levántate y pelea"</span>,
          comparto mi historia, mis luchas y las lecciones que me permitieron
          recuperar mi fuerza. Quiero inspirarte a creer en ti mismo y a
          entender que, sin importar cuántas veces caigas, siempre puedes volver
          a levantarte.
        </p>
      </div>
    </div>
